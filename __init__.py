...
bl_info = {
    ...
    "description": "Mesh data viewer. Allow lookup of vertexIn 3D viewport in properites (by deafult vertical tabs on right) under Misc tab you will find Mesh Info subtab. That's what it ads.",
    "warning": "You are a tester. Use with caution. UV cords display only in object mode. Bug report, suggestions at https://github.com/BaalNetbek/Mesh-Data-Insight/issues",
